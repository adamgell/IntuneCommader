...
public class RoleDefinitionService : IRoleDefinitionService
{
    ...
    public async Task<DeviceAndAppManagementRoleAssignment?> GetRoleAssignmentAsync(string id, CancellationToken cancellationToken = default)
    {
        return await _graphClient.DeviceManagement.RoleAssignments[id]
            .GetAsync(cancellationToken: cancellationToken);
    }
